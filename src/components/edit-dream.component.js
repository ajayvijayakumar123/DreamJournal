...
export default class EditDream extends Component {
    ...
    componentDidMount() {
        axios.get('http://localhost:5000/dreams/' + this.props.match.params.id)
            .then(response => (
                this.setState({
                    username: response.data.username,
                    description: response.data.description,
                    weird: response.data.weird,
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:5000/dreams/update' + this.props.match.params.id, dream)
        ...
        return (
            <div>
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="form-group">
                        <input type="submit" value="Edit Dream Log" className="btn btn-primary" />
                    </div>
                </form>
            </div>
        )
